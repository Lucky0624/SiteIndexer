  ...
  return (
    <div className="p-8 max-w-3xl mx-auto">
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        ...
        <div className="rounded-xl p-4 bg-white/80 dark:bg-slate-900/50 border border-slate-200 dark:border-white/10 shadow-inner text-center">
          <p className="text-2xl font-bold font-mono text-emerald-500 dark:text-emerald-400">{totalIndexed}</p>
          ...
          <table className="w-full text-sm text-slate-600 dark:text-slate-300">
            ...
            <tbody>
              {history.map((h, i) => (
                <tr
                  key={i}
                  className={`border-t border-slate-100 dark:border-white/5 ${i % 2 === 0 ? "bg-transparent" : "bg-slate-50/50 dark:bg-white/[0.015]"}`}
                >
                  ...
                  <td className="px-4 py-2.5 text-right">
                    <span className="text-emerald-500 dark:text-emerald-400 font-mono">{h.indexed}</span>
                  </td>
                  <td className="px-4 py-2.5 text-right">
                    {h.errors > 0 ? (

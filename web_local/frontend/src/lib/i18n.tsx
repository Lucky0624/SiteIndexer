...
const translations = {
  ...
  "sites.all_done": { zh: "无需再提交", en: "No submission needed" },
  ...
  "detail.inspect": { zh: "检测分类", en: "Inspect Category" },
  "detail.inspecting": { zh: "检测中...", en: "Inspecting..." },
  ...
  "detail.category": { zh: "详细分类 (GSC)", en: "GSC Category" },
  ...
  "detail.indexed": { zh: "已处理", en: "Processed" },
  ...
  "detail.gsc_indexed": { zh: "已有搜索表现", en: "Search Performance Seen" },
  ...
  "detail.google_desc": { zh: "通过 Google Indexing API 提交通知；使用 URL Inspection 核验真实收录状态。", en: "Submit notifications via Google Indexing API and verify index status through URL Inspection." },
  ...
  "history.total_indexed": { zh: "累计提交数", en: "Total Submitted" },
  ...
  "history.indexed": { zh: "已提交", en: "Submitted" },
